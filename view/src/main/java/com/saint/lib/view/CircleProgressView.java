...
public class CircleProgressView extends View {
    ...
    public CircleProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mBackPaint.setStrokeWidth(typedArray.getDimension(R.styleable.CircleProgressView_backWidth, 5));
        mBackPaint.setColor(typedArray.getColor(R.styleable.CircleProgressView_backColor, Color.LTGRAY));
        ...
        mProgPaint.setStrokeWidth(typedArray.getDimension(R.styleable.CircleProgressView_progWidth, 10));
        mProgPaint.setColor(typedArray.getColor(R.styleable.CircleProgressView_progColor, Color.BLUE));

        // 初始化进度圆环渐变色
        int startColor = typedArray.getColor(R.styleable.CircleProgressView_progStartColor, -1);
        int firstColor = typedArray.getColor(R.styleable.CircleProgressView_progFirstColor, -1);
