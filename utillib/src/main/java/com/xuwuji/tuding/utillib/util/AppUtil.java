...
public class AppUtil {
    ...
    public static int getStatusBarHeight() {
        int result = 0;
        int resId = AppConfig.getApp().getResources().getIdentifier("status_bar_height", "dimen", "android");
        if (resId > 0) {
            result = AppConfig.getApp().getResources().getDimensionPixelSize(resId);
        }
        return result;
    }
    ...
    public static int getColor(int colorResId) {
        return ContextCompat.getColor(AppConfig.getApp(), colorResId);
    }

    public static String getString(int strResId) {
        return AppConfig.getApp().getResources().getString(strResId);
    }

    public static int getDimen(int dimenResId) {
        return (int) AppConfig.getApp().getResources().getDimension(dimenResId);
    }

    public static boolean isPhone(String phone) {
//        String regex = "^((13[0-9])|(14[5,7,9])|(15([0-3]|[5-9]))|(16[1-9])|(17[0,1,3,5,6,7,8])|(18[0-9])|(19[8|9]))\\d{8}$";
        if (phone.length() != 11) {
            return false;
        }
//        else {
...
//        }
    ...
    public static int getScreenHeight() {
        ...
        ((WindowManager) AppConfig.getApp().getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay().getMetrics(outMetrics);
...
//        AppConfig.app.startActivity(new Intent(AppConfig.app, clazz));
//    }

//    public static void showAct(Class clazz, int key) {
//        Intent intent = new Intent(AppConfig.app, clazz);
...
//    }
    ...
    public static String getVersionName() {
        ...
        //获取包管理器
        PackageManager pm = AppConfig.getApp().getPackageManager();
        //获取包信息
        try {
            PackageInfo packageInfo = pm.getPackageInfo(AppConfig.getApp().getPackageName(), 0);
            //返回版本号
